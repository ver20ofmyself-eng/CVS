...
BEGIN
    ...
    -- v2.1: новые колонки для идентификации анализа
    BEGIN
        ALTER TABLE analyses ADD COLUMN IF NOT EXISTS candidate_name VARCHAR(255);
    EXCEPTION WHEN duplicate_column THEN END;
    ...
    BEGIN
        ALTER TABLE analyses ADD COLUMN IF NOT EXISTS analysis_number INTEGER;
    EXCEPTION WHEN duplicate_column THEN END;
END $$;
