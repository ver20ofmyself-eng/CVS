...
class ApiClient {
     ...
     * @param {string} cvText — форматированный текст для AI
     * @param {string|null} candidateName — "Фамилия Имя" кандидата
     * @param {string|null} sourceUrl — URL страницы резюме
     * @param {Object|null} cvStructured — структурированные данные резюме (9 блоков)
     * @param {string} promptName
     */
    async analyze(vacancyId, cvText, candidateName = null, sourceUrl = null, cvStructured = null, promptName = 'default_cv_analyzer') {
        console.log('📢 Анализ CV:', { vacancyId, candidateName, sourceUrl, promptName, hasStructured: !!cvStructured });
        ...
        // НОВОЕ: структурированные данные резюме
        if (cvStructured) {
            body.cv_structured = cvStructured;
        }
