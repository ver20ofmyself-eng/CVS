      ...
      <div v-else class="prompts-list">
        ...
        >
          ...
          <div class="card-actions">
            ...
            <!-- Сделать основным: для несистемных неосновных активных -->
            ...
            <!-- Вернуть системный как основной: показываем если есть пользовательский основной -->
            ...
            <button class="btn btn-secondary btn-sm" @click="showHistory(prompt)">📜</button>
          </div>
        </div>
      </div>
    </div>
