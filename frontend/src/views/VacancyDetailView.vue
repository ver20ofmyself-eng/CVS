      ...
      <template v-else-if="vacancy">
        ...
        <div class="description-section">
          ...
          <div class="description-tabs">
            <button
              class="tab-btn"
              :class="{ active: descriptionMode === 'formatted' }"
              @click="descriptionMode = 'formatted'"
            >
              👁️ Форматированное
            </button>
            <button
              class="tab-btn"
              :class="{ active: descriptionMode === 'raw' }"
              @click="descriptionMode = 'raw'"
            >
              📄 Текст для AI
            </button>
          </div>
          ...
          <div class="description-content">
            <div v-if="descriptionMode === 'formatted'" class="formatted-description">
              <div v-html="vacancy.description_html || '<p>Описание отсутствует</p>'"></div>
            </div>
            <div v-else class="raw-description">
              <pre>{{ vacancy.description_text || 'Описание отсутствует' }}</pre>
            </div>
          </div>
        </div>
          ...
          <div v-else-if="history.items.length" class="history-list">
            ...
            >
              ...
              <div class="history-footer">
                ...
                <span class="history-mode">{{ analysis.mode }}</span>
              </div>
            </div>
...
const descriptionMode = ref('formatted')
