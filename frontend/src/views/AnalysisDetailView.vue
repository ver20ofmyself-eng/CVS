      ...
      <template v-else-if="analysis">
        ...
        <div class="detail-header">
          <div class="title-section">
            <h1 class="page-title">Детали анализа #{{ analysis.id }}</h1>
        ...
        <!-- Ссылка на вакансию -->
        <div class="vacancy-link" v-if="analysis.vacancy_id">
          <router-link :to="`/vacancies/${analysis.vacancy_id}`" class="vacancy-link-content">
...
const repeatAnalysis = () => {
  ...
  // Здесь можно открыть расширение или предложить загрузить резюме
  // Пока просто показываем подсказку
  alert('Для повторного анализа откройте расширение на странице резюме и выберите эту вакансию')
}
