    ...
    <form @submit.prevent="handleSubmit">
      ...
      <section class="vf-section">
        ...
        <div class="vf-grid">
          ...
          <div class="vf-field">
            <label class="vf-label">Заказчик</label>
            <input v-model="form.client" type="text" class="vf-input" placeholder="Название компании-заказчика" />
          </div>

          <div class="vf-field">
            <label class="vf-label">Дата начала подбора</label>
            <input v-model="form.recruitment_start_date" type="date" class="vf-input" />
          </div>

          <div class="vf-field">
            <label class="vf-label">Дата окончания подбора</label>
            <input v-model="form.recruitment_end_date" type="date" class="vf-input" />
          </div>

          <div class="vf-field">
            <label class="vf-label">Статус вакансии</label>
            <select v-model="form.status" class="vf-select">
...
const loadVacancy = async () => {
  try {
    ...
    form.recruitment_start_date = v.recruitment_start_date || null
    form.recruitment_end_date   = v.recruitment_end_date || null
    await nextTick()
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const payload = {
      ...
      recruitment_start_date: form.recruitment_start_date || undefined,
      recruitment_end_date:   form.recruitment_end_date || undefined,
    }
